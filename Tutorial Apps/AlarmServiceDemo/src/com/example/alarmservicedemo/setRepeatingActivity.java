...
public class setRepeatingActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnSet.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent in=new Intent(setRepeatingActivity.this,MyService.class);
				//create pending intent
				//PendingIntent pi=PendingIntent.getService(context, requestCode, intent, flags)
				PendingIntent pi=PendingIntent.getService(setRepeatingActivity.this, 0, in, PendingIntent.FLAG_UPDATE_CURRENT);
				...
				am.setRepeating(AlarmManager.ELAPSED_REALTIME_WAKEUP, time, 6000, pi);
