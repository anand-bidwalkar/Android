...
public class ReadEmailAct extends Activity {
ListView list;
...
ArrayAdapter<String> adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String colNames[]={"_id","display_name","data1","raw_contact_id"};
		...
		adapter=new ArrayAdapter<String>(ReadEmailAct.this, 
